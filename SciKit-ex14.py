...
print("\n")
scores_cross_val = cross_val_score(LR, X, Y, cv=5)
...
plot_confusion_matrix(Y_test, predictions, classes=classe, title='Matriz de confusão Regressão Logística')
plt.tight_layout()
plt.show()
savefig("Figs/Iris-MatrizConfusao_LogisticRegression.png",dpi=100)
