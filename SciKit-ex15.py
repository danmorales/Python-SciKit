...
print("\n")
scores_cross_val = cross_val_score(LDA, X, Y, cv=5)
...
plot_confusion_matrix(Y_test, predictions, classes=classe, title='Matriz de confusão Linear Discriminant Analysis')
plt.tight_layout()
plt.show()
savefig("Figs/Iris-MatrizConfusao_LDA.png",dpi=100)