...
print("\n")
scores_cross_val = cross_val_score(CART, X, Y, cv=5)
...
plot_confusion_matrix(Y_test, predictions, classes=classe, title='Matriz de confusão Decision Tree Classifier')
plt.tight_layout()
plt.show()
savefig("Figs/Iris-MatrizConfusao_CART.png",dpi=100)