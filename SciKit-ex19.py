...
print("\n")
scores_cross_val = cross_val_score(SVM, X, Y, cv=5)
...
plot_confusion_matrix(Y_test, predictions, classes=classe, title='Matriz de confusão SVM')
plt.tight_layout()
plt.show()
savefig("Figs/Iris-MatrizConfusao_SVM.png",dpi=100)