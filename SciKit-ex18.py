...
print("\n")
scores_cross_val = cross_val_score(NB, X, Y, cv=5)
...
plot_confusion_matrix(Y_test, predictions, classes=classe, title='Matriz de confusão GaussianNB')
plt.tight_layout()
plt.show()
savefig("Figs/Iris-MatrizConfusao_GaussianNB.png",dpi=100)